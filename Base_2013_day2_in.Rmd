...
output: 
  ...
  institution:
    ...
    input: select
    label: 'Institution:'
    value: CODATA-RDA Summer School
bibliography: 
- oajournals.bib
- packages.bib
---
...
Mojtaba Khodadadi, Principal Investigator, SISSA

Researcher ID

ORCID: [0000-0003-4996-5623](https://orcid.org/0000-0003-4996-5623)
...
res <- orcid_bio(orcid = "0000-0003-4996-5623")
bio <- res$'0000-0003-4996-5623'$'content'
